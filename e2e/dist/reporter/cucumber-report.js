...
const originalJsonFilePath = (0, _parseEnv.env)('JSON_REPORT_FILE');
...
const originalJsonData = _fs.default.readFileSync(originalJsonFilePath, 'utf8');
let parsedData;
try {
...
_fs.default.writeFileSync(cleanedJsonFilePath, cleanedJsonData, 'utf8');
